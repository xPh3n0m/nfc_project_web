...
import application.view.CashHandlerController;
...
public class CashHandlerApp extends Application {
	...
	public void start(Stage stage) throws Exception {
		primaryStage = stage;
		primaryStage.setTitle("NFC Application - Cash Handler");
    ...
    public void initRootLayout() {
        try {
            ...
            loader.setLocation(Main.class.getResource("view/CashHandler.fxml"));
            rootLayout = (AnchorPane) loader.load();
            
            CashHandlerController controller = loader.getController();
