<?php
$header = 'K (Summer). Compute which country in which Olympics has benefited the most from playing in front of the home 
...
$sql = 'select *
from (select g.name, g.host_country, r.rank, a.avg as avg_rank, a.avg-r.rank
...
$columns = array('Olympics', 'Host Country', 'Rank', 'Average rank', 'Benefit');
?>