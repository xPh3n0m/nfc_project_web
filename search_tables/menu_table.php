...
<table class="table table-striped">
  ...
  while (!empty($table)) {
	...
	echo "<td><a href='remove/remove_menu_item.php?id=" . $row[0] . "'><i class='icon-remove'></i></a></td>";
	echo "<td><a href='index.php?p=info&amp;a=menu_item&amp;id=" . $row[0] . "' class='player-link' data-id='" . $row[0] . "' data-task='more'><i class='icon-plus'></i></a></td>";
    echo "</tr>\n";
  }
  echo "</tbody>\n";
